...
public function storecustmr($strdls,$hspn){
    ...
    if($hspn){$strcmr.="<div class='popupbackground streppupbx'>
        <div class='popupcontainerbox streppupbx'>
            ...
            <p style='color:gray;text-align:center;font-size:13px;'><strong>Note:</strong>Pay the payment to the above mobile number with the above available UPI methods. Click the 'Verify payment' button below to ask the store about your payment and don't forget to enter your payment method profile name and payment method name, Eg: Ravi via Paytm.";if($this->dec($vfdpndusr['strcstmrcsonavbl'],$this->strec)!=1||$this->dec($strdls['stravblcstoevyon'],$this->strec)==1){$strcmr.="";}$strcmr.="</p>
