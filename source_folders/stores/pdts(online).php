...
class strpdts extends dbconnect {
    ...
    public function stpdts($strdls,$rol){
        $strpds= "<div class='rmdohomepagediv'>
            ...
            <script src='https://remindo.in/stores/prdtses.js'></script>
        ...
        <div class='cmn-lbx-pdt-dsplyr-cntngdvbx'>
            ...
            <div class='lbx-dsplr-igvwrdvbx'>
                <div class='lbx-igsld-shw-dsplr-dbx'>";
                    ...
                    $pdtdsply.=">
                        <div class='lbx-lrgdsplyprvig-tg'></div><div class='lbx-lrdpy-bkdrpftr-nuldvbx'>Adding...</div>
                        <div class='lbx-pdtpto-udtbns-cntngdbx'>
            ...
            <strong>Details:</strong>
                ...
                <div class='lbx-pdt-ftres-dsplydvbx-edtstoo'>
                    ...
                    <div><div class='lbx-pdt-fchrswrtn-dvbx lbx-pdt-dnmc-cntetbls' data-phdr='Product features'></div><span class='lbx-alfhrs-mnrtd-spn'></span></div>
                </div>
            </div>
            </div>
            ...
            <div class='lbx-pdt-prcmchme-dsplybx'>
                ...
                // $pdtdsply.="<div class='lbxpthlfcmncls lbx-pdt-mtchmebtn mhmebtn' data-m=''>Match me</div>";
            $pdtdsply.="</div>
            </div>
            ...
            <div class='lbx-pdt-insghts-dsply-bx'>
                ...
                <div class='lbx-pdtmr-insghtdls-dsplybx'>
                    ...
                    // $pdtdsply.="<div class='insghtscmncls lbx-pdtinsghts-sld-ims'><strong>Match me:</strong> <span class='lbx-pdtisgts-mchme-spn'>0</span></div>";
                $pdtdsply.="</div>
            </div>
            </div>
            </div>
...
elseif(isset($_POST['ppsttevt'])){if($_POST['ppsttevt']=="frdppstt"&&isset($_GET['s'])){if($stds->vfyusr($_GET['s'])=="o"){$str=$stds->stpdts($stds->strdtls($_GET['s']),"");bdyjsn($str);}elseif($stds->vfyusr($_GET['s'])=="ebd"){$str=$stds->stpdts($stds->strdtls($_GET['s']),"");bdyjsn($str);}
else{echo "<center><h2 style='color:gray;'>This page is no longer available.</h2><br><div class='pgnavblbtn blewhtbns'><i class='fas fa-arrow-left remindosymbols' style='color:white; font-size:14px;'></i>Back to home</div><br></center>";}}}
else{
