...
function crtnwordr() {
  ...
  $(".stnwodrtostrbtn,.lbx-adto-lst-btn,.ctrnwlstbnivsbl").click(() => {
    $nwlst = true;
    if (!$(document).find(".nwryllstofnwodr").length) {
      $(".stnwodrtostrbtn").css("opacity", "1");
      var tt = new Date();
      var pt =
        tt.getDate() +
...
$(document).ready(() => {
  ...
  $(".lbx-dsplr-pewpdt-vwbtn,.lbx-dsplr-nxtpdt-vwbtn").click(() => {
  ...
  $(".lbx-adto-lst-btn").click((e) => {
    if ($(".strpgmdbdyofodrlstscntnrdvbx").length) {
      ...
      var qnty = $(`.rdo-sze-slct[name="szerdo"]:checked`).val();
...
function plcngodr() {
      ...
      $.ajax({
        ...
        beforeSend: () => {
          ...
          $(".cntnuecradrstodlvry")
            .text("continuing...")
            .prepend(
              "<i class='fas fa-sync-alt fa-spin' style='font-weight:600;font-size:16px;'></i>"
            );
          preloaderon();
        },
        dataType: "JSON",
        success: (data) => {
          ...
          $(".cntnuecradrstodlvry")
            .text("continue")
            .children(".fa-sync-alt")
            .remove();
          $(".vrfypmtsbtninppup").attr("data-vo", data.l);
          if (data.d == 1) {
            $(".strcsmradrspupbx,.lbx-ftrdsply-shld-ctngbx").hide();
            $(".lbxftr-thshws-pdtigs-dsplrbx").html("");
            $(".nwryllstofnwodr").removeClass("nwryllstofnwodr");
            ormded = true;
            $nwlst = false;
            $(
            ...
            if (data.os == 1) {
              $(".strprsntopnorclsstsdvbx").html(
                '<div class="strs*tsdvbxopn">.Open</div>'
              );
            } else {
              $(".strprsntopnorclsstsdvbx").html(
            ...
            if (data.rs == 1) {
              ...
              $(document.querySelector("#strodrnsdtosrbn"))
                .parent()
                .html(
              ...
              alert(
                "Your order has been placed! Your courier charge and payment are paid after your order gets packed by the store."
              );
            } else {
              $rvodrs = false;
              $(".strprsntrcvngordrsorntstsdvbx").html(
  ...
  function shpngdls(tgstosnd) {
    var nm = $("#rmdadrsonme").val();
    var ad = $("#rmdadrstr").val();
    var ct = $("#rmdadrcty").val();
    var st = $("#rmdadrstat").val();
    var pcd = $("#rmdadrpnstlcd").val();
    var mnb = $("#rmdadrphnmbr").val();

    if (nm.trim() == "") {
      $("#rmdadrsonme").css("border", "2px solid red");
    } else {
      $("#rmdadrsonme").css("border", "0");
    }
    if (ad.trim() == "") {
      $("#rmdadrstr").css("border", "2px solid red");
    } else {
      $("#rmdadrstr").css("border", "0");
    }
    if (ct.trim() == "") {
      $("#rmdadrcty").css("border", "2px solid red");
    } else {
      $("#rmdadrcty").css("border", "0");
    }
    if (st.trim() == "") {
      $("#rmdadrstat").css("border", "2px solid red");
    } else {
      $("#rmdadrstat").css("border", "0");
    }
    if (pcd.trim() == "") {
      $("#rmdadrpnstlcd").css("border", "2px solid red");
    } else {
      $("#rmdadrpnstlcd").css("border", "0");
    }
    if (mnb.trim() == "") {
      $("#rmdadrphnmbr").css("border", "2px solid red");
    } else {
      $(".strcsmradrspupbx").show();
      var a = /^[6789]\d{9}$/;
      if (!a.test(mnb) && mnb.length == 10) {
        $(".fmerdsply").text("Please enter a valid mobile number.");
        $("#rmdadrphnmbr").css("border", "2px solid red");
      } else if (mnb.length != 10) {
        $(".fmerdsply").text("Please enter a valid moblie number.");
        $("#rmdadrphnmbr").css("border", "2px solid red");
      } else {
        $("#rmdadrphnmbr").css("border", "0");
        $("#rmdadrphnmbr").css("border", "0");
      }
    }
    if (
      ...
      if (!a.test(mnb) && mnb.length == 10) {
        $(".fmerdsply").text("Please enter a valid mobile number.");
        return $("#rmdadrphnmbr").css("border", "2px solid red");
      } else if (mnb.length != 10) {
        $(".fmerdsply").text("Please enter a valid moblie number.");
        return $("#rmdadrphnmbr").css("border", "2px solid red");
      } else {
        ...
        $.ajax({
          ...
          success: (data) => {
            ...
            if (data == 1) {
              ...
              showsnackpopup(
                "Sorry! Failed to update the shipping details. Please try again later.",
                true,
                "non"
              );
            }
        ...
        $(".cntnuecradrstodlvry").unbind();
      }
    } else {
      $(".strcsmradrspupbx").show();
      $(".fmerdsply").text("Please fill all the details");
    }
  }
  function vfdlvryadrs(tgstosnd) {
    $(".strcsmradrspupbx").show();
    var nm = $("#rmdadrsonme").val();
    var ad = $("#rmdadrstr").val();
    var ct = $("#rmdadrcty").val();
    ...
    var pcd = $("#rmdadrpnstlcd").val();
    var mnb = $("#rmdadrphnmbr").val();
    $(".cntnuecradrstodlvry").click((e) => {
      var nnm = $("#rmdadrsonme").val();
      var nad = $("#rmdadrstr").val();
      var nct = $("#rmdadrcty").val();
      var nst = $("#rmdadrstat").val();
      var npcd = $("#rmdadrpnstlcd").val();
      var nmnb = $("#rmdadrphnmbr").val();
      if (
        nm == nnm &&
        ad == nad &&
        ct == nct &&
  ...
  document.querySelectorAll(".lstditmsinodrlstcntnrdvbx").forEach((sbn) => {
    ...
    $(sbn)
      ...
      .click((snd) => {
        ...
        tgstosnd.push(-1, "");
        var fsndclc = false;
        var minbyrch = $(".strodrspdsdsplybdymandvbx").attr("data-mnbuy");
        minbyrch =
          isNaN(minbyrch) || minbyrch == "" || minbyrch == undefined
            ? 0
            : parseInt(minbyrch);
        $("#strodrnsdtosrbn").click((e) => {
          ...
          if (tpchs >= minbyrch) {
            ...
            showsnackpopup(
              `Your bill must be atleast ${minbyrch}/-`,
              true,
              "non"
            );
          }
    ...
    if (pmn == "") {
      ...
      $.ajax({
        ...
        data: {
          ntfisask: "ysaskpttre",
          s: $("#ithnthssmrcls").val(),
          o: $(".vrfypmtsbtninppup").attr("data-vo"),
          c: cnt,
        },
        beforeSend: () => {
          $("div.pageloader").show();
...
function ttlamt() {
  ...
  alitscst.forEach((nt) => {
    ...
    var prnt = $(nt).children().children().children(".odrgstccgpcdlscntnrdvbx");
    var tlntamt =
      ($(prnt).children(".ttlamtccgecntnrdvbx").length
        ? parseInt(
            $(prnt)
              .children(".ttlamtccgecntnrdvbx")
              .children(".crcgamntcrncyspntg")
              .text()
          )
        : 0) +
      ($(prnt).children(".tamtgstcntnrdvbx").length
        ? parseInt(
            $(prnt)
              .children(".tamtgstcntnrdvbx")
              .children(".ttlamntgstcrncyspntg")
              .text()
          )
        : 0) +
      tamt;
    ...
    $.ajax({
      ...
      success: (data) => {
        ...
        window.history.pushState(
          {},
          {},
          "http://localhost/remindo/stores/storeedits?s=" + sunm
        );
      },
    });
    e.stopImmediatePropagation();
    ...
    $.ajax({
      ...
      success: (data) => {
        ...
        window.history.pushState(
          {},
          {},
          "http://localhost/remindo/stores/pdts?s=" + sunm
        );
      },
    });
    e.stopImmediatePropagation();
    ...
    $.ajax({
      ...
      success: (data) => {
        ...
        window.history.pushState(
          {},
          {},
          "http://localhost/remindo/stores/pdctmrs?s=" + sunm
        );
      },
    });
    e.stopImmediatePropagation();
