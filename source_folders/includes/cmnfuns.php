<?php
include 'C:/xampp/htdocs/remindo/analytics/trkfranlsr.php';
class cmnfns extends track{
    ...
    protected function vrfyrmdrs($cont){
        // $text = explode(" ",$cont);
        // $newtext="";
        // foreach($text as $word){
            // if(substr($word,0,1)=="@" && $word!="@" && substr($word,-1)!="!" && substr($word,-1)!="." && substr($word,-1)!="*"&&substr($word,-1)!=","){
            //    $newtext .="<a href='pndprsn.php?p=".substr(htmlentities($word),1)."'>".htmlentities($word)." </a>";
            // }elseif(substr($word,0,1)=="@" && $word!="@" && substr(htmlentities($word),-1)=="!"||substr($word,0,1)=="@" && $word!="@" && substr(htmlentities($word),-1)=="."){
            //    $newtext .="<a href='pndprsn.php.php?p=".substr(htmlentities($word),1,-1)."'>".htmlentities($word)." </a>";
            // }else{
            //     $newtext .=htmlentities($word)." ";
            // }
        // }
            // return $newtext;
    }
